...
def load_agent_wealth():
    ...
    """
    # Validation data
    val_1 = np.load(r'..\outputs\0326\135558\npy_file\agent_wealth_val.npy').flatten()
    val_2 = np.load(r'..\outputs\0327\181331\npy_file\agent_wealth_val.npy').flatten()
    val_3 = np.load(r'..\outputs\0327\181510\npy_file\agent_wealth_val.npy').flatten()

    # Test data
    test_1 = np.load(r'..\outputs\0326\135558\npy_file\agent_wealth_test.npy').flatten()
    test_2 = np.load(r'..\outputs\0327\181331\npy_file\agent_wealth_test.npy').flatten()
    test_3 = np.load(r'..\outputs\0327\181510\npy_file\agent_wealth_test.npy').flatten()
