...
def load_agent_wealth():
    ...
    """
    # Validation data
    val_1 = np.load(r'..\outputs\0406\231454\npy_file\agent_wealth_val.npy').flatten()
    val_2 = np.load(r'..\outputs\0406\231542\npy_file\agent_wealth_val.npy').flatten()
    val_3 = np.load(r'..\outputs\0406\231700\npy_file\agent_wealth_val.npy').flatten()

    # Test data
    test_1 = np.load(r'..\outputs\0406\231454\npy_file\agent_wealth_test.npy').flatten()
    test_2 = np.load(r'..\outputs\0406\231542\npy_file\agent_wealth_test.npy').flatten()
    test_3 = np.load(r'..\outputs\0406\231700\npy_file\agent_wealth_test.npy').flatten()
